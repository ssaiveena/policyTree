...
from Main_optimization.ptreeopt.plotting import graphviz_export
...
j=0
for seed in range(9):
    snapshots = pickle.load(open('../Main_optimization/snapshots/result_perf_allscen_upind_%d.pkl' % seed, 'rb'), encoding='latin1')
    data = pd.read_csv('../Main_optimization/snapshots/result_perf_allscen_upind_%d.txt' % seed, header=None, delimiter=' ')
